    ...
    jsPsych.xyzab = (function() {
        ...
        plugin.trial = function(display_element, block, trial, part) {
            ...
            case 1:
                ...
                if (trial.prompt !== "") {
                    display_element.append('<table align="center"><tbody><tr><td style="padding:30px">' + trial.x_path + '<br>Immediately<br>"Z"</td><td style="padding:30px">OR</td><td style="padding:30px">' + trial.a_path + '<br>' + trial.b_path + '<br>"/"</td></tr></tbody></table><p><br><br>' + trial.prompt);
                }
