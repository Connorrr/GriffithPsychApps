    ...
    jsPsych.ab = (function() {
        ...
        plugin.create = function(params) {
            ...
            for (var i = 0; i < trials.length; i++) {
                ...
                // timing parameters
                trials[i].timing_x = params.timing_x || 0; // defaults to 1000msec.
                trials[i].timing_xab_gap = params.timing_xab_gap || 0; // defaults to 1000msec.
