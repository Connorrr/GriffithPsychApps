...
(function($) {
    jsPsych = (function() {
        ...
        function createBlock(trial_list) {
            var block = {
                ...
                writeData: function(data_object) {
                    this.data[this.data_count] = data_object;
                    opts.on_data_update(data_object);
                },
				
				repeat: function() {
					this.data_count = this.data_count + 1;		//more data but repeat trial
					var curr_trial = this.trials[this.trial_idx];
					opts.on_trial_start();
					do_trial(this, curr_trial);
				},
        ...
        function flatten(arr, out) {
            out = (typeof out === 'undefined') ? [] : out;		//if out isn't already an array, make it one.
